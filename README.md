...
* [GoldBean API](https://goldbean-api.xyz) - Free tier API marketplace with 120+ endpoints (AI, blockchain, DeFi, weather, search). Includes Baidu OCR, translation, NLP, ERNIE LLM. Free daily credits available.
